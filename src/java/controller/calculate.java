            ...
            switch(operation){
                ...
                case ":":
                    if(num2!=0){
                        ...
                        out.append("<div><h1 style=\"color: red;\">Cannot divide with Zero</h1></div>");
                        return;
                    }
                    break;
            }
            out.append("<div><h1 style=\"color: red;\">Kết quả là: "+result+"</h1></div>");
        } catch (Exception e) {
            out.append("<div><h1 style=\"color: red;\">Invalid input</h1></div>");
        }
    } 
